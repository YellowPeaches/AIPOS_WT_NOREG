...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        AccDtoDao.createTable(db, ifNotExists);
        CommdityDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        AccDtoDao.dropTable(db, ifExists);
        CommdityDao.dropTable(db, ifExists);
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(AccDtoDao.class);
        registerDaoClass(CommdityDao.class);
